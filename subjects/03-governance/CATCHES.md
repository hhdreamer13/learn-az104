...
## Cost optimization
- ✗ **"Identify idle / underutilized resources to cut cost" → Azure Advisor** (NOT Azure Monitor). Advisor = personalized recommendations across 5 areas: **Cost, Performance, Reliability, Security, Operational excellence**; it works with Cost Management for savings tips (right-size/shut down idle VMs, buy reservations). Monitor *shows* metrics/logs but gives no cost recommendations. *(Gap: Advisor isn't in any deck or .md — genuinely untaught, fair miss.)*
